        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-gradient-to-r from-gray-900 to-black rounded-2xl flex items-center justify-center text-white text-lg font-bold animate-float shadow-lg">
                🛒
              </div>
              <div>
                ...
                <p className="text-sm text-gray-500">خطوات قليلة وسيصلك طلبك</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
              ...
              {steps.map((step, index) => {
                ...
                return (
                  <div key={step.number} className="flex items-center animate-slide-in" style={{ animationDelay: `${index * 150}ms` }}>
                    <div className={`flex flex-col items-center ${index > 0 ? 'mr-6' : ''}`}>
                      <div className={`w-16 h-16 rounded-3xl flex items-center justify-center font-bold text-sm transition-all duration-500 relative overflow-hidden ${
                        isCompleted 
                        ...
                        {isActive && !isCompleted && (
                          <div className="absolute inset-0 bg-white/20 shimmer-effect rounded-3xl"></div>
                        )}
                      </div>
                      <span className={`text-sm mt-4 font-bold text-center max-w-24 leading-tight transition-colors duration-300 ${
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="glass-effect rounded-3xl shadow-2xl border-2 border-gray-900 overflow-hidden animate-fade-in">
              <div className={`bg-gradient-to-r ${steps[currentStep - 1]?.color || 'from-gray-900 to-black'} px-10 py-8 relative overflow-hidden`}>
                ...
                <div className="flex items-center gap-5 text-white relative z-10">
                  ...
                  <div>
                    ...
                    <p className="text-white/90 text-lg">الخطوة {currentStep} من {steps.length}</p>
                  </div>
                </div>
              </div>
                ...
                {currentStep === 1 && (
                  <div className="space-y-8 animate-fade-in">
                    {cartItems.map((item, index) => (
                      <div 
                        key={item.id} 
                        className="flex items-center glass-effect rounded-3xl p-8 border-2 border-gray-900 hover:border-gray-800 hover:shadow-xl transition-all duration-500 animate-slide-in"
                      ...
                      >
                        <div className="relative">
                          <img
                            ...
                            className="w-24 h-24 object-cover rounded-2xl ml-8 shadow-lg transition-transform duration-300 hover:scale-110"
                          />
                          <div className="absolute -top-3 -right-3 w-8 h-8 bg-gradient-to-r from-gray-900 to-black text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg animate-pulse">
                            {item.quantity}
                          </div>
                        </div>
