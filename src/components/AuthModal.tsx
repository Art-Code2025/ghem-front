      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
        ...
        <div className="relative bg-gradient-to-r from-purple-600 via-pink-600 to-rose-600 p-6 text-center">
          ...
          <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
            {step === 'email' ? <Mail className="w-8 h-8 text-white" /> : step === 'otp' ? <Lock className="w-8 h-8 text-white" /> : <User className="w-8 h-8 text-white" />}
          </div>
              ...
              <div className="grid grid-cols-4 gap-4">
                {otp.map((digit, index) => (
                  <input
                    ...
                    className="w-full h-14 text-center text-xl font-bold border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                    placeholder="0"
                    maxLength={1}
                    disabled={loading}
                  />
