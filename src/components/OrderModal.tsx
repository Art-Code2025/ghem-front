        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-6 text-white">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-2xl font-bold">الطلب #{order.id}</h2>
              ...
              <div className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <button
                    ...
                    className="flex flex-col items-center p-4 bg-white rounded-xl border-2 border-blue-200 hover:border-blue-400 hover:shadow-lg transition-all"
                  >
                    <Copy className="w-6 h-6 text-blue-600 mb-2" />
                    <span className="text-sm font-medium text-gray-700">نسخ العنوان</span>
                  </button>
                  <button
                    onClick={() => copyToClipboard(order.customerPhone, 'رقم الهاتف')}
                    className="flex flex-col items-center p-4 bg-white rounded-xl border-2 border-green-200 hover:border-green-400 hover:shadow-lg transition-all"
                  >
                    <Phone className="w-6 h-6 text-green-600 mb-2" />
                    <span className="text-sm font-medium text-gray-700">نسخ الرقم</span>
                  </button>
                  <button
                    onClick={printInvoice}
                    className="flex flex-col items-center p-4 bg-white rounded-xl border-2 border-purple-200 hover:border-purple-400 hover:shadow-lg transition-all"
                  >
