...
const CategoryEdit: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center" dir="rtl">
        <div className="text-center">
          ...
          <p className="text-gray-600">جارٍ تحميل بيانات التصنيف...</p>
        </div>
      </div>
    );
  }
  ...
  if (!category) {
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center" dir="rtl">
        <div className="text-center">
          <h2 className="text-xl font-bold text-gray-900 mb-2">التصنيف غير موجود</h2>
          <Link to="/dashboard?tab=categories" className="text-orange-600 hover:text-orange-700">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <Link to="/dashboard?tab=categories" className="flex items-center text-gray-600 hover:text-orange-600 transition-colors">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-lg font-bold text-gray-900">تعديل التصنيف: {category.name}</h1>
                  <p className="text-sm text-gray-500">تحديث بيانات ومعلومات التصنيف</p>
                </div>
              </div>
            </div>
